//inicia la base de datos een workbench
...
const initDB = async () => {
    try {
        ...
        try {
            connection = await getPool(); // Usa getPool() para obtener la conexión

            console.log('Borrando tablas existentes');

            await connection.query('DROP TABLE IF EXISTS linksvotes');
